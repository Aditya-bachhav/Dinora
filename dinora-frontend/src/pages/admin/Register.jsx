...
// NOTE: matches the backend's current registration contract exactly —
// name/email/password only. restaurant_name is intentionally NOT collected
// here: when omitted, the backend attaches the new admin to the sole
// existing restaurant (see dinora-backend README, "Restaurant scoping").
// If you deploy for a second restaurant, register via the API directly
// with a restaurant_name until this form is extended.
      ...
      <div className="dinora-auth-page">
        <div className="dinora-auth-shell">
          <div className="dinora-brand">
            ...
            <div className="dinora-brand-tagline">
              Restaurant Management
            </div>
          </div>

          <div className="dinora-auth-card">
            <h1 className="dinora-auth-heading">Create your account</h1>

            <p className="dinora-auth-subtitle">
              Set up secure access to your restaurant dashboard.
            </p>
